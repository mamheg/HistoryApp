  ...
  return (
    <div className="fixed inset-0 z-[60] bg-white flex flex-col animate-slide-up font-sans">
      ...
      <div className="flex-1 overflow-y-auto no-scrollbar bg-white">
        <div className="w-full h-[35vh] flex items-center justify-center p-6 bg-white animate-pop-in">
          <img 
              ...
              {product.modifiers.sizes.map(size => {
                ...
                return (
                  <button
                    ...
                    className={`flex-1 rounded-xl text-sm font-semibold transition-all duration-200 z-10 relative active:scale-95 ${
                      isSelected ? 'text-gray-900 shadow-sm' : 'text-gray-400 hover:text-gray-600'
                    }`}
                  >
                    {size.name.split(' ')[0]}
                    {isSelected && (
